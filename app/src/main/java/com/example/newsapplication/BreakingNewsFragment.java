 ...
 */
public class BreakingNewsFragment extends Fragment implements RelatedNewsRecyclerViewAdapter.OnNewsFragmentClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_breaking_news, null);
        recyclerView = root.findViewById(R.id.breakingNewsRelatedRecyclerView);
