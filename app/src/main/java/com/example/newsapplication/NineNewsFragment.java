 ...
 */
public class NineNewsFragment extends Fragment implements RelatedNewsRecyclerViewAdapter.OnNewsFragmentClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_nine_news, null);
        recyclerView = root.findViewById(R.id.nineNewsRelatedRecyclerView);
