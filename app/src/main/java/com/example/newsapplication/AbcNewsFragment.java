 ...
 */
public class AbcNewsFragment extends Fragment implements RelatedNewsRecyclerViewAdapter.OnNewsFragmentClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_abc_news, null);
        recyclerView = root.findViewById(R.id.abcNewsRelatedRecyclerView);
