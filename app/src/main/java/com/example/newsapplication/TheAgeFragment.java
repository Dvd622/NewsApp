 ...
 */
public class TheAgeFragment extends Fragment implements RelatedNewsRecyclerViewAdapter.OnNewsFragmentClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_the_age, null);
        recyclerView = root.findViewById(R.id.theAgeRelatedRecyclerView);
